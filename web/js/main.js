...
import * as hardening from './views/hardening.js';
...
const ICONS = {
  ...
  hardening:
    '<svg viewBox="0 0 20 20" width="16" height="16"><path d="M10 2.2l6 2.4v5c0 3.6-2.5 6.6-6 8.2-3.5-1.6-6-4.6-6-8.2v-5z" stroke="currentColor" stroke-width="1.5" fill="none" stroke-linejoin="round"/><path d="M7.4 10.1l1.9 1.9 3.4-3.8" stroke="currentColor" stroke-width="1.6" fill="none" stroke-linecap="round" stroke-linejoin="round"/></svg>',
  docker:
...
const ROUTES = [
  ...
  { group: 'Inspect', id: 'hardening', label: 'Hardening', title: 'Security hardening audit', view: hardening },
